...
ems_edgar = makeBottomupEms(sYear, eYear);
...
ems_pert(:,11) = global_baseline.ems_anal(baseline_ind, 11);
ems_pert(:,12) = global_baseline.ems_anal(baseline_ind, 12);

ems_pert(:,13) = global_baseline.ems_anal(baseline_ind, 13);
ems_pert(:,14) = global_baseline.ems_anal(baseline_ind, 14);

ems_pert(:,15) = global_baseline.ems_anal(baseline_ind, 15);
ems_pert(:,5) = global_baseline.ems_anal(baseline_ind, 5);
ems_pert(:,6) = global_baseline.ems_anal(baseline_ind, 6);
%ems_pert = global_baseline.ems_anal(t_baseline,:)t;
%ems_pert(:,1) = ems_pert(1,1)*ones(nT,1);
%ems_pert(:,2) = ems_pert(1,2)*ones(nT,1);
...
ems_baseline(:,1) = ems_baseline(1,1)*ones(nT,1);
ems_baseline(:,2) = ems_baseline(1,2)*ones(nT,1);
...
ems_pert(:,3) = (ems_pert(:,1) - ems_edgar.(nh_sector)(1)) ./ ems_pert(:,1) * ems_pert(1,3) + (ems_edgar.(nh_sector)(1)) ./ ems_pert(:,1) * signature.(sector);
ems_pert(:,4) = (ems_pert(:,2) - ems_edgar.(sh_sector)(1)) ./ ems_pert(:,2) * ems_pert(1,4) + (ems_edgar.(sh_sector)(1)) ./ ems_pert(:,2) * signature.(sector);
