...
H2O_strat = read_strat_obs('global_strat_obs.nc', {'mlsanomh2oq', 'mlsh2oq'});
H2O_var_percent = H2O_strat{1} ./ H2O_strat{2} + 1;
...
obs.nh_n2o_strat_err = obs.nh_n2o_strat * synthetic_error;
obs.sh_n2o_strat_err = obs.sh_n2o_strat * synthetic_error;
