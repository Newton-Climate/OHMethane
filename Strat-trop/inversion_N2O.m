...
%%% = Global inversion with H2O and N2O informing strat-trop exchange time
...
data_filename  = 'case5_N2O_real_inversion';

%%% Describing experiment to be exported to .mat file 
fprintf('*** Using H2O strat to inform strat-trop exchange and N2O strat as constraint ***\n')
...
global fit_strat_exchange use_strat_N2O
% Plotting flags
...
fit_strat_exchange = true; % are we fitting for strat exchange time?
use_strat_N2O = true;
use_strat_H2O= true; % inform apriori with H2O strat variations 
...
obs.nh_n2o_strat_err = sqrt(obs.nh_n2o_strat_err);
obs.sh_n2o_strat_err = sqrt(obs.nh_n2o_strat_err);
...
if use_strat_H2O
    ...
    ems(:,15) = 30*ones(nT,1); % strat-trop exchange time in years 
